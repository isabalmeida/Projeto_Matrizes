...
def obter_ingredientes_lanche(tipo_lanche):
    ingredientes = {
        "For Mata-fome": ['pao', 'hamburguer', 'bacon', 'maionese', 'barbecue'],
        "Barba-byte": ['pao', 'hamburguer', 'queijo', 'bacon', 'maionese'],
        "Default": ['pao', 'hamburguer', 'queijo', 'presunto', 'alface', 'tomate', 'maionese'],
        "Ba-code": ['pao', 'hamburguer', 'queijo', 'bacon', 'barbecue']
    }
